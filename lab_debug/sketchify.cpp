...
HSLAPixel* myFavoriteColor(double saturation) {
    static HSLAPixel pixel(170, saturation, 0.5);
    return &pixel;
}
...
double edgeScore(PNG* im, unsigned x, unsigned y) {
    ...
    // The comment needs to be changed, but my intention is that the students 
    // don't need to know exactly how this part works
